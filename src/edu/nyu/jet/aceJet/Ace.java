...
public class Ace {
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter(
				new FileWriter("/Users/nuist/documents/NlpResearch/ice-eval/results_depWeights_v1_selectiveTest", true)); // append
		...
		writer.write("Random Selection:" + "\n");
		writer.write("Weights by frequency, Batch = all, trained on all combinedTable." + "\n");
