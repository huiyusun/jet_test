...
public class AceRelation {
	...
	/**
	 * a list of the patterns of this relation (each of type String)
	 */
	...
	public AceRelation(String id, String type, String subtype, String relClass, AceEventArgumentValue arg1,
			AceEventArgumentValue arg2) {
		this.id = id;
		this.type = type;
	 ...
	 *          the XML element from the APF file containing information about this entity
	 * @param acedoc
	 *          the AceDocument of which this AceRelation is a part
	 */
	...
	public AceRelation(Element relationElement, AceDocument acedoc, String fileText) {
		...
		/*
		 * NodeList mentionLists = relationElement.getElementsByTagName("relation_mentions"); if (mentionLists.getLength()
		 * != 1) { System.out.println ("*** missing or multiple 'relation_mentions' tags"); return; } Element mentionList =
		 * (Element) mentionLists.item(0); NodeList mentionElements = mentionList.getElementsByTagName("relation_mention");
		 */
