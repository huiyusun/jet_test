...
public class Ace_entitySubtypes {

	final static Logger logger = LoggerFactory.getLogger(Ace_entitySubtypes.class);
	...
	public static void init(String propertyFile) throws IOException {
		...
		String relationDepPathPosFile = null;
		String relationDepPathNegFile = null;
