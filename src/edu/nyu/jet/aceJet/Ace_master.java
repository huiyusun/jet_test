...
public class Ace_master {

	final static Logger logger = LoggerFactory.getLogger(Ace_master.class);
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter(
				new FileWriter("/Users/nuist/documents/NlpResearch/ice-eval/results_depWeights_v1_patternItrForPos", true)); // append
		...
		// writer.write("Pos Set iterations:" + "\n");
