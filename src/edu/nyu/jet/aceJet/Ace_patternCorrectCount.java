...
public class Ace_patternCorrectCount {

	final static Logger logger = LoggerFactory.getLogger(Ace_patternCorrectCount.class);
	...
	public static void main(String[] args) throws IOException {
		...
		combineTriples.combine(); // combine triples
