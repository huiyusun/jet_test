...
public class Ace_weights {

	final static Logger logger = LoggerFactory.getLogger(Ace_weights.class);
	...
	public static void main(String[] args) throws IOException {
		...
		BufferedWriter writer = new BufferedWriter(
				new FileWriter("/Users/nuist/documents/NlpResearch/ice-eval/optimal_weights_ORG-AFF_real", true)); // append
		...
		writer.write("ORG-AFF | all docs (599) | patterns_real" + "\n");
		writer.write("negDiscount = 0.9 | minThreshold = 0.5 | k = 3" + "\n");
		...
		for (int delete = 2; delete <= 10; delete++) {
			...
			pathRelationExtractor.setNegDiscount(0.9);
			...
			String parameterString = String.format("replace:%.2f insert:%.2f delete:%.2f", replace / 5.0, insert / 5.0,
					delete / 5.0);
			...
			System.out.println("[TUNING] " + parameterString + " = " + scoresStr);
			writer.write("[TUNING] " + parameterString + " = " + scoresStr + "\n");
			reader.close();
		}
		// }
		// }
