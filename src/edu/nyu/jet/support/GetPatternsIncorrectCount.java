...
public class GetPatternsIncorrectCount {
	public static void Separate() {
		...
		// relationsSetOrg.add("GPE GPE"); // technically permitted, but never occur in key
		...
		try {
			input = new BufferedReader(new FileReader("/Users/nuist/documents/NlpResearch/ice-eval/patternsIncorrectCount"));
			output = new BufferedWriter(
					new FileWriter("/Users/nuist/documents/NlpResearch/ice-eval/patternsIncorrectCount_ORG-AFF_perfect_v1"));

			TreeSet<String> perfect = new TreeSet<String>();
